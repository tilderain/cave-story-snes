...
// Extern declarations matching the provided ASM file
...
extern unsigned char soundbank_Cemetery;
extern unsigned char soundbank_Charge;
extern unsigned char soundbank_EyesofFlame;
extern unsigned char soundbank_Gameover;
extern unsigned char soundbank_Geothermal;
...
extern unsigned char soundbank_Jenka1;
extern unsigned char soundbank_Jenka2;
extern unsigned char soundbank_LabyrinthFight;
extern unsigned char soundbank_LastBattle;
extern unsigned char soundbank_LastCave;
extern unsigned char soundbank_LivingWaterway;
extern unsigned char soundbank_Meltdown2;
extern unsigned char soundbank_MimigaTown;
extern unsigned char soundbank_MischievousRobot;
...
extern unsigned char soundbank_Plant;
...
extern unsigned char soundbank_Safety;
...
extern unsigned char soundbank_Toroko;
extern unsigned char soundbank_Tyrant;
extern unsigned char soundbank_Victory;
extern unsigned char soundbank_White;
extern unsigned char soundbank_Zombie;

inline void play_music_track(uint8_t id) {
    switch (id) {
        case MOD_MISCHIEVOUS_ROBOT:  spcSetBank(&soundbank_MischievousRobot); break;
        case MOD_SAFETY:             spcSetBank(&soundbank_Safety); break;
        case MOD_GAMEOVER:           spcSetBank(&soundbank_Gameover); break;
        case MOD_GRAVITY:            spcSetBank(&soundbank_Gravity); break;
        case MOD_ON_TO_GRASSTOWN:    spcSetBank(&soundbank_OntoGrasstown); break;
        case MOD_MELTDOWN_2:         spcSetBank(&soundbank_Meltdown2); break;
        case MOD_EYES_OF_FLAME:      spcSetBank(&soundbank_EyesofFlame); break;
        case MOD_GESTATIONA:         spcSetBank(&soundbank_Gestation); break;
        case MOD_MIMIGA_TOWN:        spcSetBank(&soundbank_MimigaTown); break;
        case MOD_GOT_ITEM:           spcSetBank(&soundbank_GotItem); break;
        case MOD_BALROG:             spcSetBank(&soundbank_BalrogTheme); break;
        case MOD_CEMETERY:           spcSetBank(&soundbank_Cemetery); break;
        case MOD_PLANT:              spcSetBank(&soundbank_Plant); break;
        case MOD_PULSE:              spcSetBank(&soundbank_Pulse); break;
        case MOD_VICTORY:            spcSetBank(&soundbank_Victory); break;
        case MOD_GET_HEART_TANK:     spcSetBank(&soundbank_GetHeartTank); break;
        case MOD_TYRANT:             spcSetBank(&soundbank_Tyrant); break;
        case MOD_RUN:                spcSetBank(&soundbank_Run); break;
        case MOD_JENKA_1:            spcSetBank(&soundbank_Jenka1); break;
        case MOD_LABYRINTH_FIGHT:    spcSetBank(&soundbank_LabyrinthFight); break;
        case MOD_ACCESS:             spcSetBank(&soundbank_Access); break;
        case MOD_OPPRESSION:         spcSetBank(&soundbank_Oppression); break;
        case MOD_GEOTHERMAL:         spcSetBank(&soundbank_Geothermal); break;
        case MOD_CAVE_STORY:         spcSetBank(&soundbank_CaveStory); break;
        case MOD_MOONSONG:           spcSetBank(&soundbank_Moonsong); break;
        case MOD_HEROS_END:          spcSetBank(&soundbank_HeroEnd); break;
        case MOD_SCORCHING_BACK:     spcSetBank(&soundbank_ScorchingBack); break;
        case MOD_QUIET:              spcSetBank(&soundbank_Quiet); break;
        case MOD_LAST_CAVE:          spcSetBank(&soundbank_LastCave); break;
        case MOD_BALCONY:            spcSetBank(&soundbank_Balcony); break;
        case MOD_CHARGE:             spcSetBank(&soundbank_Charge); break;
        case MOD_LAST_BATTLE:        spcSetBank(&soundbank_LastBattle); break;
        case MOD_THE_WAY_BACK_HOME:  spcSetBank(&soundbank_TheWayBackHome); break;
        case MOD_ZOMBIE:             spcSetBank(&soundbank_Zombie); break;
        case MOD_BREAK_DOWN:         spcSetBank(&soundbank_BreakDown); break;
        case MOD_RUNNING_HELL:       spcSetBank(&soundbank_RunningHell); break;
        case MOD_JENKA_2:            spcSetBank(&soundbank_Jenka2); break;
        case MOD_LIVING_WATERWAY:    spcSetBank(&soundbank_LivingWaterway); break;
        case MOD_SEAL_CHAMBER:       spcSetBank(&soundbank_SealChamber); break;
        case MOD_TOROKOS_THEME:      spcSetBank(&soundbank_Toroko); break;
        case MOD_WHITE:              spcSetBank(&soundbank_White); break;
        
        // The following tracks were in song_info_xm but not in the ASM file:
        // case MOD_PIER_WALK:       spcSetBank(&soundbank_PierWalk); break;
        // case MOD_PEOPLE_OF_THE_ROOT: spcSetBank(&soundbank_PeopleOfTheRoot); break;
        // case MOD_WIND_FORTRESS:   spcSetBank(&soundbank_WindFortress); break;
...
void play_music_track2(MusicId id) {
	play_music_track(id);
}
void game_main(uint8_t load) {
   ...
   // REG_CGDATA = 0x00;
    //REG_CGDATA = 0x00;
		...
		extern u8* mariogfx;
		consoleVblank();
		dmaCopyVram(map_buffer_bg1, 0x6000, 3200);
